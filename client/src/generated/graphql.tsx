...
export type InputErrorFragment = { __typename?: "FieldError" } & Pick<
  FieldError,
  "field" | "message"
>;
...
export type PostInfoFragment = { __typename?: "Post" } & Pick<
  ...
  | "updatedAt"
> & {
    creator: { __typename?: "User" } & Pick<User, "id" | "username" | "email">;
  };

export type PostInfoWithTextSnippetsFragment = { __typename?: "Post" } & Pick<
  Post,
  | "id"
  | "title"
  | "textSnippet"
...
export type UserResponseFragment = { __typename?: "UserResponse" } & {
  errors?: Maybe<Array<{ __typename?: "FieldError" } & InputErrorFragment>>;
  user?: Maybe<{ __typename?: "User" } & RegularUserFragment>;
};

export type NewCreatedPostFragment = { __typename?: "Post" } & Pick<
  Post,
  | "id"
  | "title"
  | "text"
...
export type CreatePostMutation = { __typename?: "Mutation" } & {
  createPost: { __typename?: "Post" } & NewCreatedPostFragment;
};
...
export type UpdatePostMutation = { __typename?: "Mutation" } & {
  updatePost?: Maybe<
    { __typename?: "Post" } & Pick<
      Post,
      "id" | "title" | "text" | "creatorId" | "createdAt" | "updatedAt"
    >
  >;
};
...
export type PostsSnippetsQueryVariables = Exact<{
  limit: Scalars["Int"];
  cursor?: Maybe<Scalars["String"]>;
}>;
...
`;
export const PostInfoWithTextSnippetsFragmentDoc = gql`
  fragment PostInfoWithTextSnippets on Post {
    id
    title
    textSnippet
    points
...
/**
 * __usePostsSnippetsQuery__
 *
 * To run a query within a React component, call `usePostsSnippetsQuery` and pass it any options that fit your needs.
 * When your component renders, `usePostsSnippetsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePostsSnippetsQuery({
 *   variables: {
 ...
 * });
 */
export function usePostsSnippetsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    PostsSnippetsQuery,
    PostsSnippetsQueryVariables
  >
) {
  return Apollo.useQuery<PostsSnippetsQuery, PostsSnippetsQueryVariables>(
    PostsSnippetsDocument,
    baseOptions
  );
}
export function usePostsSnippetsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    PostsSnippetsQuery,
    PostsSnippetsQueryVariables
  >
) {
  return Apollo.useLazyQuery<PostsSnippetsQuery, PostsSnippetsQueryVariables>(
    PostsSnippetsDocument,
    baseOptions
  );
}
export type PostsSnippetsQueryHookResult = ReturnType<
  typeof usePostsSnippetsQuery
>;
export type PostsSnippetsLazyQueryHookResult = ReturnType<
  typeof usePostsSnippetsLazyQuery
>;
export type PostsSnippetsQueryResult = Apollo.QueryResult<
  PostsSnippetsQuery,
  PostsSnippetsQueryVariables
>;
